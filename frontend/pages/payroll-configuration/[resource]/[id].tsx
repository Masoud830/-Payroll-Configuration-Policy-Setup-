...
export default function PayrollConfigDetailPage() {
  ...
  async function onDelete() {
    ...
    const resourceName = meta.title.toLowerCase();
    if (!confirm(`Delete this ${resourceName}?`)) return;
            ...
            <>
              ...
              <form onSubmit={onSave} className="mt-6">
                ...
                {(perms.canApproveReject || perms.canDelete) ? (
                  <div className={`mt-10 grid grid-cols-1 gap-4 ${perms.canApproveReject && perms.canDelete ? 'lg:grid-cols-3' : perms.canApproveReject ? 'lg:grid-cols-2' : 'lg:grid-cols-1'}`}>
